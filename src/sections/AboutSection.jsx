    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto px-6">
                ...
                {/* ─── Profile Card with SpotlightCard ─── */}
                <motion.div
                ...
                >
                    <SpotlightCard
                        className="p-8 md:p-10 rounded-2xl glass-deep mb-16 border border-white/5
                ...
                {/* ─── Soft Skills — SpotlightCard Layout ─── */}
                <motion.div
                ...
                >
                    ...
                    >
                        {softSkills.map((skill, index) => (
                            ...
                            >
                                <SpotlightCard
                                    className="p-5 rounded-xl glass cursor-default border border-white/5
